...
| 정책(policy) | `BIZ-002-01`·`BIZ-002-03`(`B2`·`B3`)·`BIZ-002-04`(`B3`) · `BIZ-001-01`·`BIZ-001-04`(`B4`) · `BIZ-005-02` ①(`B3`)·`BIZ-005-04`(`B4`) · `DATA-002-01` ①(`B5`) · `DATA-004-01`(`B3`)·`DATA-004-02`(`B2`) · `DATA-001-01`(`B3`~`B6`) · `DATA-002-05`(`B2`) · `OPS-004-01`(`B2`~`B6` 질의 실행)·`OPS-004-03`(상위 경계에 참여 — 커넥션 소실은 상위의 500 `EX-BIZ-003` 으로 귀결되며 본 프로세스가 새 코드를 만들지 않는다)·`OPS-004-04`(로그 기록 — FN-015) | 적용 규칙·지점 |
