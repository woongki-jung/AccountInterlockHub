...
| 2 | GET /api/consent/:requestKey | — | 200 ConsentItem[](구성 소속만, display_order 정렬) | B1b(FN-008) |

- **데이터 검증**: 해당 config_id 동의 항목만 노출(BIZ-002-01), 타 구성 항목 미포함.
...
| 접근성 | SCR-005 | Banner role=alert·aria-live | 오류 스크린리더 대응 |
