...
|------|---------|-----------|-----|:--:|
| [ADM/tc_ADM-01.md](ADM/tc_ADM-01.md) | ADM-01 | PROC-101 | SVC-001 | 14 |
...
| [USR/tc_USR-01.md](USR/tc_USR-01.md) | USR-01 | PROC-201·202 | SVC-004 | 17 |
...
| [BAT/tc_BAT-02.md](BAT/tc_BAT-02.md) | BAT-02 | PROC-402 | SVC-007 | 9 |
...
| SVC | 복잡도 | 최소 | 실제 | 파일 |
|-----|------|:--:|:--:|------|
| SVC-001 등록·편집(CRUD) | 입력·저장 | 12 | 14 | ADM-01 |
| SVC-002 조회·목록·활성/삭제(CRUD) | 입력·저장 | 12 | 16 | ADM-02 |
| SVC-003 관리자 접근·로그인 | 복합 | 12 | 16 | ADM-03 |
| SVC-004 이용 동의 | 복합 | 15 | 17 | USR-01 |
| SVC-005 연동 실행·전달·저장 | 복합·외부 | 15 | 21 | USR-02(12)+BAT-01(9) |
| SVC-006 처리상태 API | 조회 | 8 | 9 | API-01 |
| SVC-007 상태 보관 배치 | 조회·배치 | 8 | 9 | BAT-02 |

### 5-2. PROC → 검증 TC (양방향 추적)

| PROC | 검증 BR/EX | 검증 TC |
|------|-----------|---------|
| PROC-101 | BR-101·102, EX-BIZ-001/002·SEC-004/005·AUTH-001/002·FN-999 | ADM-01_001~014 |
...
| PROC-201 | EX-OPS-001·SEC-004/005·DATA-002·FN-999 | USR-01_001~007·016~017 |
...
| PROC-402 | BR-401, (내부)배치 실패, EXC-DATA-04 정합 | BAT-02_001~009 |
...
| BIZ-001 | ADM-01_001 | ADM-01_003·004·005·006 | ADM-01_007·008 |
| BIZ-002 | USR-01_008·009 | USR-01_010·011·015 | USR-01_002(구성 소속만) |
...
| OPS-003 | BAT-02_007 | BAT-02_008 | BAT-02_005(멱등) |
