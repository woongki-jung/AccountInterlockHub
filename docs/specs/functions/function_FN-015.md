...
| 호출 PROC | 전 API PROC(PROC-101·102·103·105·106·201·202·203·301·302·303) |
| 연관 정책 | (공통 규칙) — EX 코드는 각 정책·서비스 정의서 인용 |
| 참조 데이터 | 전 응답 DTO(MDL-101·102·202·302·304 등), EX 코드 카탈로그([spec-functions.md](spec-functions.md)) |
| 관련 IA 항목 | 공통 |
