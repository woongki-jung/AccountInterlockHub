...
- **데이터 목적**: 연동 구성 1건에 종속되는 전달 파라미터 정의를 보관한다. 서비스 A 진입 시 원천 키를 매핑하고, 동의 완료 후 서비스 B 전달 페이로드 구성에 사용한다. 정의(메타)만 저장하며 실제 값(회원 정보 포함)은 저장하지 않는다.
- **관련 PRD 요구사항**: [`../../prd/PRD.md`](../../prd/PRD.md) §수행 범위 "서비스 A의 호출 주소·전달 파라미터" / [`../../prd/devspec/external-apis.md`](../../prd/devspec/external-apis.md) §1·2 접점 / IA [`../../prd/ia/IA.md`](../../prd/ia/IA.md) `ADM-01`·`USR-02`.
...
- **삭제/보관 조건**: PROC-101 편집 교체 시 하드 삭제 후 재삽입, 또는 부모 구성 물리 삭제 시 ENT-001 CASCADE.
